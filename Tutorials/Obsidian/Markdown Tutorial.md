---
aliases: [Markdown Tutorial]
tags: [Markdown]
location: []
title: Markdown Tutorial
linter-yaml-title-alias: Markdown Tutorial
date created: 2023-04-02 02:05:04 am
date modified: 2023-04-15 8:47:22 am
---
...
Currently, it supports the formats below:
...
Link to a page: [[Linking Notes and Files/Internal Links]].
...
[[Advanced Topics/Using Obsidian URI|Obsidian URI]] links can be used to open notes in Obsidian either from another Obsidian vault or another program.

For example, you can link to a file in a vault like so (please note the [[Advanced Topics/Using Obsidian URI#Encoding|required encoding]]):
...
**Note:** This vault have additional custom made [Checkboxes](Checkboxes.md)
...
If you put links in tables, they will work, but if you use [[Linking Notes and Files/Aliases|aliases]], the pipe must be escaped with a `\` to prevent it being read as a table element.
...
> [!info]
> Here's a callout block.
> It supports **markdown** and [[Linking Notes and Files/Internal Links|wikilinks]].
